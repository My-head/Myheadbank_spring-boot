...
public class TransferController {
    ...
    public String betweenAccountsPost(
        ...
        transactionService.betweenAccountsTransfer(transferFrom, transferTo, amount, usdAccount, bynAccount);
    ...
    public String toSomeoneElsePost(@ModelAttribute("recipientName") String recipientName, @ModelAttribute("accountType") String accountType, @ModelAttribute("amount") String amount, Principal principal) {
        User user = userService.findByUsername(principal.getName());
        Recipient recipient = transactionService.findRecipientByName(recipientName);
        transactionService.toSomeoneElseTransfer(recipient, accountType, amount, user.getUsdAccount(), user.getBynAccount());
